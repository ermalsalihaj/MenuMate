  ...
  <div className="viewmenu">
          ...
          {meals.map(meal=>(
            <div className="viewmenu"  key={meal.idmenu}>
                <div className='meal-page'>
                  ...
                  <div className='meal'>
                    <MenuItem title={meal.title} price={meal.price} tags={meal.description}/>
                  </div>
                </div>
                  {auth && role === "admin" && (
                   <div className="btn">
    ...
    <div className="app__bg__wrapper__section__drinks">
      <div className="app__wrapper_info_drinks">
        ...
        <div className='app__bg__wrapper__padding_drinks' id='awards'>
          ...
          <div className='app__wrapper_info' id='img_drink'>
          </div>
    </div>
    ...
    <div className="app__specialMenu flex__center section__padding" id="menu">
      ...
      <div className="app__specialMenu-menu">
        <div className="app__specialMenu-menu_wine flex__center">
          { auth && role === "admin" && (
            <Link to={"/addDrink"} className="app__specialMenu-menu_heading">Add drink</Link>
          )}
          ...
          {drinks.map(drink=>(
            <div className="viewmenu"  key={drink.iddrinks}>
                <div className='drink-page'>
                  ...
                  <div className='drink'>
                    <MenuItem title={drink.name} price={drink.price} tags={drink.ingredients}/>
                  </div>
                </div>
                  {auth && role === "admin" && (
                   <div className="btn">
                    <p className="delete" onClick={()=>handleDeleteDrink(drink.iddrinks)}>Delete</p>
                    {/* <Link className="update-btn" to={`/update/${drink.iddrinks}`}><p className="update" > Update</p></Link> */}
                   </div>
                  )}
            </div>
          ))}
